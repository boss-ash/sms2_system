...
<head>
    ...
    <link href="<?= BASE_URL ?>/assets/css/layout.css?v=12" rel="stylesheet">
    ...
    <link href="<?= BASE_URL ?>/assets/css/loader.css?v=5" rel="stylesheet">
...
<div id="smsPageLoader" class="sms-page-loader is-active" role="status" aria-live="polite" aria-busy="true" aria-label="Loading">
    ...
    <div class="sms-loader-content">
        <div class="sms-loader-brand">
            <div class="sms-loader-ring" aria-hidden="true"></div>
